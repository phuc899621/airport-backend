...
const createHanhKhachValidator = () => ({
    layHanhKhachParams: Joi.object({
        maHanhKhach: Joi.string().required().messages(stringMsg('Mã hành khách', true))
    }),
    layHanhKhachQuery: Joi.object({
...
export default createHanhKhachValidator
